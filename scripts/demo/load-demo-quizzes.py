...
from quizz_http.fixtures import load_quizzes
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Load demo quizzes through admin HTTP endpoints.")
    ...
    try:
        ...
        results = AdminCatalogClient(http).ensure_quizzes(quizzes)
        print_results("Demo Quizzes", results)
        return 0
