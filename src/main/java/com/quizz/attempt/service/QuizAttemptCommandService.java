 ...
 *
 * <p>This service owns start, resume, restart, autosave, manual submit,
 ...
 * both attempt id and user id rather than trusting client-provided ownership.</p>
 */
public interface QuizAttemptCommandService {
     ...
     *
     * <p>An active non-overdue attempt is resumed without consuming another
     ...
     * when the allowance is in cooldown.</p>
     */
     ...
     *
     * <p>The method requires an active attempt and an available remaining right.
     ...
     * existing attempt is overdue, it is auto-submitted instead of restarted.</p>
     */
     ...
     *
     * <p>The attempt is resolved by attempt id and user id, the selected option
     ...
     * {@code TIME_EXPIRED} from the already-saved answers.</p>
     */
     ...
     *
     * <p>Scoring uses the saved attempt snapshot, {@code submittedAt} is the
     ...
     *
     * <p>The query is scoped to the supplied user id and must not mutate other
     * users' attempts.</p>
     */
     ...
     *
     * <p>Before expiry, the submitted payload must contain one answer entry for
     ...
     * previously saved answers with {@code TIME_EXPIRED}.</p>
     */
